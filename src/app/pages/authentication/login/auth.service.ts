...
export class AuthService {
  ...
  public get usuario():Users {
    if (this._usuario != null) {
      ...
      this._usuario = JSON.parse(sessionStorage.getItem('usuario')) as Users;
      return this._usuario;
    }
    return new Users();
  }
 ...
 //  const urlEndpoint = 'http://localhost:60079/oauth/token';
 // const urlEndpoint="http://localhost:8991/login/login"
  ...
  /*  this._usuario.nombre = payload.nombre;
    ...
    this._usuario.idUser=payload.idUser
